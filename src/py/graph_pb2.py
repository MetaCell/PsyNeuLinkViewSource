...
_PARAMTYPES = _descriptor.EnumDescriptor(
  name='paramTypes',
  full_name='graph.paramTypes',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_PARAMTYPES)

paramTypes = enum_type_wrapper.EnumTypeWrapper(_PARAMTYPES)
INITIALIZATION = 0
VALIDATION = 1
EXECUTION = 2
PROCESSING = 3
...
_COMPONENTMETA = _descriptor.Descriptor(
  name='ComponentMeta',
  full_name='graph.ComponentMeta',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='graph.ComponentMeta.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='graph.ComponentMeta.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='graph.ComponentMeta.type', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COMPONENTPARAMS = _descriptor.Descriptor(
  ...
  full_name='graph.ComponentParams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='apiMethod', full_name='graph.ComponentParams.apiMethod', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='params', full_name='graph.ComponentParams.params', index=1,
...
_COMPONENTMETA.fields_by_name['type'].enum_type = _PARAMTYPES
_COMPONENTPARAMS.fields_by_name['params'].message_type = _COMPONENTMETA
...
DESCRIPTOR.message_types_by_name['ComponentMeta'] = _COMPONENTMETA
...
DESCRIPTOR.enum_types_by_name['paramTypes'] = _PARAMTYPES
...
ComponentMeta = _reflection.GeneratedProtocolMessageType('ComponentMeta', (_message.Message,), {
  'DESCRIPTOR' : _COMPONENTMETA,
  '__module__' : 'graph_pb2'
  # @@protoc_insertion_point(class_scope:graph.ComponentMeta)
  })
_sym_db.RegisterMessage(ComponentMeta)

ComponentParams = _reflection.GeneratedProtocolMessageType('ComponentParams', (_message.Message,), {
  'DESCRIPTOR' : _COMPONENTPARAMS,
  '__module__' : 'graph_pb2'
  # @@protoc_insertion_point(class_scope:graph.ComponentParams)
  })
...
_SERVEGRAPH = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='AddComponent',
    full_name='graph.ServeGraph.AddComponent',
    index=10,
    containing_service=None,
