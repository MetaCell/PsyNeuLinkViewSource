...
class ServeGraphStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddComponent = channel.unary_unary(
                '/graph.ServeGraph/AddComponent',
                request_serializer=graph__pb2.ComponentParams.SerializeToString,
                response_deserializer=graph__pb2.ScriptCompositions.FromString,
                )
...
def add_ServeGraphServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddComponent': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=graph__pb2.ComponentParams.FromString,
                    response_serializer=graph__pb2.ScriptCompositions.SerializeToString,
            ),
    }
...
class ServeGraph(object):
    ...
    def AddComponent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/graph.ServeGraph/AddComponent',
            graph__pb2.ComponentParams.SerializeToString,
            graph__pb2.ScriptCompositions.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
